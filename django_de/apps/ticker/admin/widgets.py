...
class TaggingAutocompleteWidget(forms.TextInput):
    ...
    class Media:
        css = {
            'all': ('theme/autocomplete.css',)
        }
        
        js = (
            'theme/js/jquery-1.2.6.min.js',
            'theme/js/jquery.bgiframe.min.js',
            'theme/js/jquery.dimensions.js',
            'theme/js/jquery.ajaxQueue.js',
            'theme/js/jquery.autocomplete.min.js',        
        )
