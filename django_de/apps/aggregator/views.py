...
def add_feed(request):
    ...
    if request.POST:
        ...
        if form.is_valid():
            form.save()            
            message = u'Ein neuer Feed wurde hinzugefügt und wartet auf Freischaltung: %s' % form.cleaned_data.get('feed_url', '')
            mail_admins(u'Community: Neuer Feed hinzugefügt', message, True)            
